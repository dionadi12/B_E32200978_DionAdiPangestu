...
<head>
  ...
  <link href="/backend/assets/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
  <!-- easy pie chart-->
  ...
  <link href="/backend/css/jquery-jvectormap-1.2.2.css" rel="stylesheet">
  <!-- Custom styles -->
  <link rel="stylesheet" href="css/fullcalendar.css">
  <link href="/backend/css/widgets.css" rel="stylesheet">
  <link href="/backend/css/style.css" rel="stylesheet">
  <link href="/backend/css/style-responsive.css" rel="stylesheet" />
  <link href="/backend/css/xcharts.min.css" rel=" stylesheet">
  <link href="/backend/css/jquery-ui-1.10.4.min.css" rel="stylesheet">
  <!-- =======================================================
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="/backend/img/avatar-mini.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="/backend/img/avatar-mini2.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="/backend/img/avatar-mini3.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="/backend/img/avatar-mini4.jpg"></span>
                                    <span class="subject">
